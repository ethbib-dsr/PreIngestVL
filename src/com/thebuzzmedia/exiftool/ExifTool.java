...
/**
 * Source: https://github.com/thebuzzmedia/exiftool
 */
...
public class ExifTool {
	...
	public enum Tag {
		ISO("ISO", Integer.class), APERTURE("ApertureValue", Double.class), WHITE_BALANCE(
                ...
                MIME_TYPE("MIMEType", String.class), MODIFY_DATE("ModifyDate", Date.class);
	...
	public Map<Tag, String> getImageMeta(File image, Format format, Tag... tags)
		...
		if (stayOpen) {
			...
			streams.writer.write("-S\n"); // compact output
				...
				//modified because single quotes were also inserted into exif values
				/*
					streams.writer.write("='");
